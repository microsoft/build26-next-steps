...
| Session | Presenters |
| --- | --- |
| BRK209: Japan Wrap-up Session | [Tadashi Okazaki](https://build.microsoft.com/en-US/speakers/1768245294609build26-1770723178216001H10N?source=/speakers) |
| BRK240: Build context‑aware agents at scale with Microsoft IQ | [Marco Casalaina](https://build.microsoft.com/en-US/speakers/1768245294609build26-1758304897855001h9Qq?source=/speakers) |
| BRK241: From prototype to production: build and run agents at scale | [Tina Schuchman](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775078152694001T9OH?source=/speakers), [Jeff Hollan](https://build.microsoft.com/en-US/speakers/1768245294609build26-1774284996168001pgz1?source=/speakers) |
| BRK242: Turn your agents into action: connect tools, APIs, and data | [Joe Filcik](https://build.microsoft.com/en-US/speakers/1768245294609build26-1776459863938001ayf1?source=/speakers), [Ronak Chokshi](https://build.microsoft.com/en-US/speakers/1768245294609build26-1751939918029001Ts21?source=/speakers), [Maria Naggaga](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775078342403001SpDz?source=/speakers) |
| BRK243: Claw and agent harness in Microsoft Foundry | [Shawn Henry](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775078836270001Iwf7?source=/speakers), [Amanda Foster](https://build.microsoft.com/en-US/speakers/1768245294609build26-1768498845637001TuQh?source=/speakers), [Glenn Condron](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775581852702001WrWI?source=/speakers) |
| BRK244: Agent supervision is the new senior engineering skill | [swyx  (Shawn Wang)](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775516734838001pZmI?source=/speakers) |
| BRK245: Breakout session with Peter Steinberger | [Peter Steinberger](https://build.microsoft.com/en-US/speakers/1768245294609build26-1772238022106001lZo4?source=/speakers) |
| BRK246: Context engineering for agents: connect agents with enterprise knowledge | [Pablo Castro](https://build.microsoft.com/en-US/speakers/1768245294609build26-1774553037071001kDWR?source=/speakers) |
| BRK247: Mark and Scott learn...the future of software engineering | [Scott Hanselman](https://build.microsoft.com/en-US/speakers/1768245294609build26-1769008130185001WAvh?source=/speakers), [Mark Russinovich](https://build.microsoft.com/en-US/speakers/1768245294609build26-1776631798007001nGQM?source=/speakers) |
| DEM330: Build multimodal agents that reason, interact, and take action | [Henk Boelman](https://build.microsoft.com/en-US/speakers/1768245294609build26-1754963585693001VLHf?source=/speakers) |
| DEM331: Turn APIs, tools, and data into real agent velocity | [Chu Lahlou](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775581764225001HWz2?source=/speakers) |
| DEM332: From Prompt to Production: Agentic App Development with Enterprise-Grade Controls |  |
| DEM333: How Foundry integrates with open-source frameworks and tools | [Nagkumar Arkalgud](https://build.microsoft.com/en-US/speakers/1768245294609build26-1776181207688001qvOn?source=/speakers), [Facundo Santiago](https://build.microsoft.com/en-US/speakers/1768245294609build26-1766703128481001X0K3?source=/speakers) |
| DEM334: Build agents where work happens: chats, channels, and meetings in Microsoft Teams | [Lily Du](https://build.microsoft.com/en-US/speakers/1768245294609build26-1777487605958001URqq?source=/speakers), [Umang Sehgal](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775594818790001AuRe?source=/speakers) |
| DEM360: Discovering Power App Data with M365 Copilot using MCP | [Christine Flora](https://build.microsoft.com/en-US/speakers/1768245294609build26-1772578847951001DH4K?source=/speakers) |
